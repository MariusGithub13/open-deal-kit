...
*Valuation · agent 14 of 20 in [The Deal Team](../../README.md)*

Frames a valuation range using comparable logic.

**When to use:** When you need a rough value before negotiating.
**What you get back:** A reasoned multiple range with the logic shown.
...
2. A reasoned multiple range for a business like this, with the factors that push it to the low vs high end.
